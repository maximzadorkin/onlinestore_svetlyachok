...
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки) values(1, 4, 65000);
...
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки) values(2, 5, 365000);
