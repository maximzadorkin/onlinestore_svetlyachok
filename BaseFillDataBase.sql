...
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки, Дата) values(1, 4, 65000, '04.05.2021');
...
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки, Дата) values(2, 5, 365000, '27.05.2021');
