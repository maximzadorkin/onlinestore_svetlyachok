...
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки, Дата) values(1, 4, 65000, '2021.04.05');
insert into Сделки_Товары(Сделки_id, Товары_id, КоличествоТовара, Штука_Стоимость) values(1, 1, 1, 65000);
insert into Доставки(Дата, Адрес, Доставлено, Сотрудники_id_курьер, Сделки_id) values('2021.04.06', 'Авиамоторная', 1, 6, 1);
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки, Дата) values(1, 4, 150000, '2021.04.25');
insert into Сделки_Товары(Сделки_id, Товары_id, КоличествоТовара, Штука_Стоимость) values(2, 2, 2, 75000);
insert into Доставки(Дата, Адрес, Доставлено, Сотрудники_id_курьер, Сделки_id) values('2021.04.26', 'Авиамоторная', 1, 6, 2);
insert into Сделки(Клиенты_id, Сотрудники_id, Стоимость_сделки, Дата) values(2, 5, 365000, '2021.05.27');
insert into Сделки_Товары(Сделки_id, Товары_id, КоличествоТовара, Штука_Стоимость) values(3, 1, 1, 65000);
insert into Сделки_Товары(Сделки_id, Товары_id, КоличествоТовара, Штука_Стоимость) values(3, 5, 2, 150000);
insert into Доставки(Дата, Адрес, Доставлено, Сотрудники_id_курьер, Сделки_id) values('2021.05.28', 'Заводская', 1, 7, 3);